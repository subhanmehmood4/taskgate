# Trajectory — 14-tiebreak-in-notes (final)
...
```
passed=0 failed=1
Lists differ: ['Zoe Ames', 'Ben Chen', 'Ada Chen'] != ['Zoe Ames', 'Ada Chen', 'Ben Chen']

First differing element 1:
'Ben Chen'
'Ada Chen'

- ['Zoe Ames', 'Ben Chen', 'Ada Chen']
?               ^^^         ^^^
